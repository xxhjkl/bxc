...
wget -t1 -T120 https://image.moeclub.org/GoogleDrive/1kIaUVRznVP6yLnGtmk_afSKI9gJzXQgc -O /tmp/ChainDB_pruned_latest.tar.gz
...
rm -rf /tmp/ChainDB_pruned_latest.tar.gz
systemctl start nkn-node.service
fi
}
